...
# Reduce CUDA allocator fragmentation during the FSDP update (inherited by the Ray
# workers started from this process); a caller-provided value is kept as is.
...
echo "  entropy coef:  $ENTROPY_COEFF  alloc_conf=$PYTORCH_CUDA_ALLOC_CONF"
