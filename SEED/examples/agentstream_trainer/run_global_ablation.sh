...
SUITE_PREFIX="${AGENTSTREAM_ABLATION_PREFIX:-seed_${AGENTSTREAM_MODEL_TAG}_agentstream_${AGENTSTREAM_RUN_VERSION}${_as_skill_suffix}_n${AGENTSTREAM_NUM_TASKS}_${AGENTSTREAM_RL_STREAM_PROFILE}_b${BATCH_SIZE}_steps${TOTAL_STEPS}}"
