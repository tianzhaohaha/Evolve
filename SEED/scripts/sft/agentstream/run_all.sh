...
if [[ "$AGENTSTREAM_RUN_PREPARE" == "true" ]]; then
    ...
    NUM_TASKS="$AGENTSTREAM_SFT_NUM_TASKS" \
    HOLDOUT_AFTER_TASKS="$AGENTSTREAM_NUM_TASKS" \
    HOLDOUT_TASKS="$AGENTSTREAM_VAL_TASKS" \
    ...
    MAX_STEPS_JSON="$AGENTSTREAM_MAX_STEPS_JSON" \
    OBS_MAX_CHARS_JSON="$AGENTSTREAM_OBS_MAX_CHARS_JSON" \
    SKILL_GEN_WORKERS="$AGENTSTREAM_SFT_SKILL_GEN_WORKERS" \
    SKILL_MODE="$AGENTSTREAM_SEED_SKILL_MODE" \
    MAX_STEP_SKILLS="$AGENTSTREAM_SEED_ANALYSIS_MAX_STEP_SKILLS" \
    SKILL_MAX_COMPLETION_TOKENS="$AGENTSTREAM_SEED_ANALYSIS_MAX_COMPLETION_TOKENS" \
...
if [[ "$AGENTSTREAM_RUN_SFT" == "true" ]]; then
    ...
    ULYSSES_SEQUENCE_PARALLEL_SIZE="$AGENTSTREAM_SFT_ULYSSES_SEQUENCE_PARALLEL_SIZE" \
