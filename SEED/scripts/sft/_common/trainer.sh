...
SFT_LOG_DATA_SAMPLES="${SFT_LOG_DATA_SAMPLES:-0}"
...
trainer_args=(
    ...
    "trainer.log_data_samples=$SFT_LOG_DATA_SAMPLES"
    "trainer.log_data_samples_freq=$SFT_LOG_DATA_SAMPLES_FREQ"
    "trainer.log_data_samples_max_chars=$SFT_LOG_DATA_SAMPLES_MAX_CHARS"
