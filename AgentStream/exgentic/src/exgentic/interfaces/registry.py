...
BENCHMARKS: dict[str, RegistryEntry] = {
    ...
    "hle": RegistryEntry(
        slug_name="hle",
        display_name="HLE",
        module="exgentic.benchmarks.hle.hle_benchmark",
        attr="HLEBenchmark",
        kind="benchmark",
        subsets=("test",),
        subset_arg="subset",
...
AGENTS: dict[str, RegistryEntry] = {
    ...
    "ace": RegistryEntry(
        slug_name="ace",
        display_name="ACE Agent",
        module="exgentic.agents.ace.ace_agent",
        attr="ACEAgent",
        kind="agent",
    ),
    "a_mem": RegistryEntry(
        slug_name="a_mem",
        display_name="A-Mem Agent",
        module="exgentic.agents.a_mem.a_mem_agent",
        attr="AMemAgent",
        kind="agent",
    ),
    "reasoning_bank": RegistryEntry(
        slug_name="reasoning_bank",
        display_name="ReasoningBank Agent",
        module="exgentic.agents.reasoning_bank.rb_agent",
        attr="ReasoningBankAgent",
        kind="agent",
    ),
    "autoskill": RegistryEntry(
        slug_name="autoskill",
        display_name="AutoSkill Agent",
        module="exgentic.agents.autoskill.autoskill_agent",
        attr="AutoSkillAgent",
        kind="agent",
    ),
    "harness": RegistryEntry(
        slug_name="harness",
        display_name="Harness Agent",
        module="exgentic.agents.harness.harness_agent",
        attr="HarnessAgent",
        kind="agent",
    ),
}
